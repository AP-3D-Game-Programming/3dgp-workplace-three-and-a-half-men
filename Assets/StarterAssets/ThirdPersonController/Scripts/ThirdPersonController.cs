...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        private void Move()
        {
            ...
            targetSpeed *= 0.3f / transform.localScale.x;
            ...
            float scaleFix = 1f / transform.localScale.x; // örn. scale 0.2 ise bu 5 eder
            _animationBlend = Mathf.Lerp(_animationBlend, targetSpeed * scaleFix, Time.deltaTime * SpeedChangeRate);
